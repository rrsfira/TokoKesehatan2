...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 06 Bulan Mei 2025 pada 18.18
...
(98, 87, 2, 3, 1, '16000.00', NULL, NULL),
(99, 87, 2, 5, 1, '243000.00', NULL, NULL),
(100, 88, 2, 3, 1, '16000.00', NULL, NULL),
(103, 91, 2, 3, 1, '16000.00', NULL, NULL);
...
CREATE TABLE `transactions` (
  ...
  `snap_token` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `snap_redirect_url` text COLLATE utf8mb4_unicode_ci NOT NULL,
...
INSERT INTO `transactions` (`id`, `user_id`, `shipping_method_id`, `status`, `payment`, `total`, `token`, `method`, `snap_token`, `snap_redirect_url`, `created_at`, `updated_at`) VALUES
...
(87, 2, NULL, 'menunggu', '0.00', '269000.00', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6Miwicm9sZSI6InVzZXIiLCJpYXQiOjE3NDY1NDYyMjYsImV4cCI6MTc0NjYzMjYyNn0.GQWr5hPWuyfi4Z5cyDd_Kdm0boY1rLI-bGU56', 'Midtrans Payment Gateway', 'fad6ceb1-1379-40cc-8ace-cbcf5a5331e3', 'https://app.sandbox.midtrans.com/snap/v4/redirection/fad6ceb1-1379-40cc-8ace-cbcf5a5331e3', '2025-05-06 16:10:09', '2025-05-06 16:10:09'),
(88, 2, NULL, 'berhasil', '0.00', '26000.00', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6Miwicm9sZSI6InVzZXIiLCJpYXQiOjE3NDY1NDYyMjYsImV4cCI6MTc0NjYzMjYyNn0.GQWr5hPWuyfi4Z5cyDd_Kdm0boY1rLI-bGU56', 'COD (Bayar di Tempat)', '', '', '2025-05-06 16:10:58', '2025-05-06 16:10:58'),
(91, 2, NULL, 'menunggu', '0.00', '26000.00', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6Miwicm9sZSI6InVzZXIiLCJpYXQiOjE3NDY1NDYyMjYsImV4cCI6MTc0NjYzMjYyNn0.GQWr5hPWuyfi4Z5cyDd_Kdm0boY1rLI-bGU56', 'Midtrans Payment Gateway', '084ac2e1-9f18-4dae-9675-ba24d168a362', 'https://app.sandbox.midtrans.com/snap/v4/redirection/084ac2e1-9f18-4dae-9675-ba24d168a362', '2025-05-06 16:17:15', '2025-05-06 16:17:15');
...
--
-- Struktur dari tabel `vendors_deliveries`
--
...
--
-- Indeks untuk tabel `vendors_deliveries`
--
...
--
-- AUTO_INCREMENT untuk tabel `vendors_deliveries`
--
ALTER TABLE `vendors_deliveries`
...
--
-- Ketidakleluasaan untuk tabel `vendors_deliveries`
--
ALTER TABLE `vendors_deliveries`
